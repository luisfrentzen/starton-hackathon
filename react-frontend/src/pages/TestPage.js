...
export default function TestPage() {
	...
	return (
		<div
			className='bg-cover bg-left-bottom relative overflow-hidden'
		...
		>
			...
			<div className='w-screen h-screen transition-all ease-in-out duration-1000 transform translate-x-0 slide'>
