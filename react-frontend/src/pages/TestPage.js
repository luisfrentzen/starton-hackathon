...
export default function TestPage() {
	...
	//Untuk menyimpan kata yang sudah diinput
	const [w, setWord] = useState("")

	//Untuk toggle ada error atau tidak
	const [isError, setIsError] = useState(false)

	//Untuk menyimpan error yang terjadi
	const [error, setError] = useState([])

	//Untuk penanda sedang loading atau tidak
	const [isLoading, setLoading] = useState(false)

	//Untuk penanda modal hasi terbuka atau tidak
	const [isModalOpened, setmodalOpened] = useState(false)

	//Untuk menyipmpan data result probs dan juga majornya
