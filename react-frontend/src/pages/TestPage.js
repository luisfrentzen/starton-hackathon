...
export default function TestPage() {
	...
	const submitHandler = (word) => {
		...
		//next slide
		setQuestion((q) => [...q, <Question title='Testing' desc='description' example='example' maxLength={maxLength} submitHandler={submitHandler}/>])
	...
	const [question, setQuestion] = useState([<Question title='Testing' desc='description' example='example' maxLength={maxLength} submitHandler={submitHandler}/>])
	...
	return (
		...
		>
			...
			>
				<svg className='w-16 h-16 animate-spin text-white' viewBox='0 0 512 512'>
					<path
						fill='currentColor'
						...
						<div className='py-8 w-full text-center pb-20 mx-10'>
							<div className='flex sm:justify-between w-full sm:items-center mb-4 flex-col sm:flex-row'>
								<div className='text-left'>
									<p className='text-xl sm:text-3xl font-bold text-white'>Tell me about yourself</p>
							...
							<div className='flip h-80'>
								<div className={`flip-content w-full ${isExample ? 'flip-content-clicked' : ''}`}>
									...
									<div className='flip-example bg-indigo-900 text-gray-300 p-4 rounded-lg w-full h-80 text-left py-4 px-6 text-lg'>
										I love to learn about computer science and problem solving. I think I'm really good at
