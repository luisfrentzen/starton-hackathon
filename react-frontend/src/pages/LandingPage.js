            ...
            <div className="relative h-full">
              <div className="px-8 h-5/6 flex flex-col items-center justify-center">
                <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl xl:text-7xl">
                  <span className="block max-w-screen-md bg-gradient-to-br from-white to-blue-300 bg-clip-text text-transparent pb-4">
                    Discover your future
                  </span>
                </h1>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl lg:text-2xl text-blue-50 sm:max-w-4xl">
                  Stop risking your way, <b>discover</b> what is best for your
                  study with <b>cholarr AI</b>.
                </p>
            ...
            <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
              <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
                <div className="mt-6">
                  ...
                  <p className="sm:mt-6 text-lg sm:text-xl text-gray-500 text-justify">
                    Navigate through our majors database. You can discover
                    useful information about every major we have catalogued such
                    as the career path you could pursue and how to achieve it.
                  </p>
              ...
              <div className="mt-12 sm:mt-16 lg:mt-0">
                <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                  <img
                    className="w-full lg:absolute lg:left-20 lg:h-full lg:w-auto lg:max-w-none"
